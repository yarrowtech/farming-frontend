...
import './state_gov.css';

const schemesData = [
  { id: 1, name: 'CM-KISAN Yojana' },
  { id: 2, name: 'Soil Health Card Scheme' },
  { id: 3, name: 'Kisan Credit Card (KCC)' },
  { id: 4, name: 'Mukhya Mantri Fasal Bima Yojana (PMFBY)' },
...
function StateGov() {
  ...
  return (
    <>
      ...
      {!isSubmitted ? (
        <div className="state_container" id="state_details">
          <div className="state_card">
            <h1>State details</h1>
            <form onSubmit={handleSubmit}>
              <label>State name</label>
              <input type="text" placeholder="Enter the name of Your State" required />
